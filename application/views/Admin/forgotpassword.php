                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                    <div class="pdd-horizon-30 pdd-vertical-30">
                                                        ...
                                                        <form method="post" action="<?php echo site_url('admin/Forgotpass/forgot'); ?>">
                                                        ...
                                                        <!--     <div class="mt-3 text-center">
                                                                Don’t have an account? <a href="<?php echo site_url('admin/signup') ?>">Sign up</a>
                                                            </div> -->
...
action="<?php echo site_url('admin/forgot'); ?>"
</html>