                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                    <div class="pdd-horizon-30 pdd-vertical-30">
                                                        ...
                                                        <p class="mrg-btm-15 font-size-13">Please your new Password</p>
                                                        <form action=""
                                                            <div class="form-group">
                                                                <input type="text" class="form-control" name="Password" placeholder="Enter new password"><br>
                                                            ...
                                                            <div class="mt-3 text-center">
                                                                <button class="btn btn-block btn-info"   >Change Password</button>
                                                            </div>
