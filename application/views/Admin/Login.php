                                                ...
                                                <div class="card-body">
                                                    <div class="pdd-horizon-30 pdd-vertical-30">
                                                        <div class="text-center mb-3">
                                                            ...
                                                            <a href="<?php echo site_url('admin/login') ?>"><img class="img-responsive inline-block" src="<?php echo base_url();?>/assets/images/logo/logo-dark.png" alt=""></a>
                                                        ...
                                                        <form method="post" , action="<?php echo site_url('admin/login');?>">
                                                            ...
                                                            <div class="form-group">
                                                                <input type="password" class="form-control" placeholder="Password" name="password" id="typepass1">
                                                            ...
                                                            <div class="mt-3 text-center">
                                                                Forgot password? <a href="<?php echo site_url('admin/forgotpass') ?>">Reset</a><br>
