...
<head>
    ...
    <title>Recondition Product Outlet Login</title>
                                                ...
                                                <div class="card-body">
                                                    <div class="pdd-horizon-30 pdd-vertical-30">
                                                        <div class="text-center mb-3">
                                                            ...
                                                            <a href="<?php echo site_url('UserLogin') ?>"><img class="img-responsive inline-block" src="<?php echo base_url();?>/assets/images/logo/logo-dark.png" alt=""></a>
                                                            <!-- <img class="img-responsive inline-block" src="<?php echo base_url();?>/assets/images/logo/logo-dark.png" alt=""> -->
                                                        </div>
                                                        <p class="mrg-btm-15 font-size-13">Please enter your username and password to Login</p>
                                                        <form method="post" , action="<?php echo site_url('UserLogin/login');?>">
                                                            <div class="form-group">
                                                                <input type="text" class="form-control" placeholder="Username" name="uemail" value="<?php echo set_value('email');?>">
                                                            </div>
                                                            <div class="form-group">
                                                                <input type="password" class="form-control" placeholder="Password" name="upassword" id="typepass">
                                                            ...
                                                            <div class="mt-3 text-center">
                                                                <button class="btn btn-block btn-primary" name="btnlogin">Login</button>
                                                            </div>

                                                            <div class="mt-3 text-center">
                                                                Forgot password? <a href="<?php echo site_url('UserLogin/forgot') ?>">Reset</a><br>

                                                                Don’t have an account? <a href="<?php echo site_url('UserLogin/signup') ?>">Sign up</a>
                                                            </div>
